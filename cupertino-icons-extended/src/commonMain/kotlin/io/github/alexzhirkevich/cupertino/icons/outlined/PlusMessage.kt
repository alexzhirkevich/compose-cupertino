...
public val CupertinoIcons.Outlined.PlusMessage: ImageVector
    get() {
        ...
        _plusMessage = Builder(name = "PlusMessage", defaultWidth = 26.5781.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.8633f, 10.7695f)
                curveTo(7.8633f, 11.332f, 8.2617f, 11.7305f, 8.8594f, 11.7305f)
                lineTo(12.3047f, 11.7305f)
                lineTo(12.3047f, 15.1875f)
                curveTo(12.3047f, 15.7734f, 12.7031f, 16.1836f, 13.2773f, 16.1836f)
                curveTo(13.8633f, 16.1836f, 14.2734f, 15.7734f, 14.2734f, 15.1875f)
                lineTo(14.2734f, 11.7305f)
                lineTo(17.7305f, 11.7305f)
                curveTo(18.3164f, 11.7305f, 18.7266f, 11.332f, 18.7266f, 10.7695f)
                curveTo(18.7266f, 10.1719f, 18.3164f, 9.7617f, 17.7305f, 9.7617f)
                lineTo(14.2734f, 9.7617f)
                lineTo(14.2734f, 6.3281f)
                curveTo(14.2734f, 5.7188f, 13.8633f, 5.3203f, 13.2773f, 5.3203f)
                curveTo(12.7031f, 5.3203f, 12.3047f, 5.7188f, 12.3047f, 6.3281f)
                lineTo(12.3047f, 9.7617f)
                lineTo(8.8594f, 9.7617f)
                curveTo(8.2617f, 9.7617f, 7.8633f, 10.1719f, 7.8633f, 10.7695f)
                close()
            }
        }
        .build()
