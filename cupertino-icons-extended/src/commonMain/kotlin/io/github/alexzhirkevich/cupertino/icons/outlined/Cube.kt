...
public val CupertinoIcons.Outlined.Cube: ImageVector
    get() {
        if (_cube != null) {
            return _cube!!
        }
        _cube = Builder(name = "Cube", defaultWidth = 23.6602.dp, defaultHeight = 25.793.dp,
                viewportWidth = 23.6602f, viewportHeight = 25.793f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(23.0977f, 19.6758f, 23.6602f, 19.0547f, 23.6602f, 17.3789f)
                lineTo(23.6602f, 8.0977f)
                curveTo(23.6602f, 6.8789f, 23.2148f, 6.1172f, 22.2305f, 5.5547f)
                lineTo(13.9336f, 0.8438f)
                curveTo(12.5156f, 0.0234f, 11.1445f, 0.0234f, 9.7266f, 0.8438f)
                lineTo(1.4414f, 5.5547f)
                curveTo(0.4453f, 6.1172f, 0.0f, 6.8789f, 0.0f, 8.0977f)
                lineTo(0.0f, 17.3789f)
                curveTo(0.0f, 19.0547f, 0.5742f, 19.6758f, 1.6406f, 20.2852f)
                close()
                moveTo(2.6953f, 18.7383f)
                curveTo(2.0156f, 18.3633f, 1.7813f, 17.9648f, 1.7813f, 17.3203f)
                ...
                curveTo(21.8789f, 17.9648f, 21.6445f, 18.3633f, 20.9766f, 18.7383f)
                close()
