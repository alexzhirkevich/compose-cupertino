...
public val CupertinoIcons.Outlined.Desktopcomputer: ImageVector
    get() {
        if (_desktopcomputer != null) {
            return _desktopcomputer!!
        }
        _desktopcomputer = Builder(name = "Desktopcomputer", defaultWidth = 27.9375.dp,
                defaultHeight = 24.4336.dp, viewportWidth = 27.9375f, viewportHeight =
                24.4336f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.0391f, 15.1055f, 1.8867f, 14.9766f, 1.8867f, 14.6016f)
                ...
                lineTo(26.0508f, 14.6016f)
                curveTo(26.0508f, 14.9766f, 25.8867f, 15.1055f, 25.5352f, 15.1055f)
                close()
