...
public val CupertinoIcons.Filled.Cube: ImageVector
    get() {
        if (_cube != null) {
            return _cube!!
        }
        _cube = Builder(name = "Cube", defaultWidth = 23.7773.dp, defaultHeight = 25.7695.dp,
                viewportWidth = 23.7773f, viewportHeight = 25.7695f).apply {
