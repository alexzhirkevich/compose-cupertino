...
public val CupertinoIcons.Outlined.Umbrella: ImageVector
    get() {
        if (_umbrella != null) {
            return _umbrella!!
        }
        _umbrella = Builder(name = "Umbrella", defaultWidth = 23.3672.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.6836f, 10.6875f)
                curveTo(10.2656f, 10.6875f, 8.9063f, 11.3203f, 8.0508f, 12.3633f)
                curveTo(7.9922f, 12.4453f, 7.9453f, 12.4453f, 7.8867f, 12.3633f)
                curveTo(7.1133f, 11.2969f, 6.0234f, 10.7578f, 4.6172f, 10.7578f)
                curveTo(3.1172f, 10.7578f, 1.8633f, 11.3672f, 0.832f, 12.6328f)
                lineTo(1.8984f, 12.7266f)
                curveTo(2.4375f, 8.1445f, 6.375f, 4.4063f, 11.6836f, 4.4063f)
                curveTo(16.9805f, 4.4063f, 20.918f, 8.1211f, 21.457f, 12.7031f)
                lineTo(22.5234f, 12.6094f)
                curveTo(21.4922f, 11.3672f, 20.25f, 10.7578f, 18.75f, 10.7578f)
                curveTo(17.3438f, 10.7578f, 16.2539f, 11.2969f, 15.4688f, 12.3633f)
                curveTo(15.4219f, 12.4453f, 15.375f, 12.4336f, 15.3164f, 12.3633f)
                curveTo(14.4609f, 11.3203f, 13.0898f, 10.6875f, 11.6836f, 10.6875f)
                close()
