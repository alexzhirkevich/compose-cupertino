...
public val CupertinoIcons.Outlined.Nosign: ImageVector
    get() {
        if (_nosign != null) {
            return _nosign!!
        }
        _nosign = Builder(name = "Nosign", defaultWidth = 23.9062.dp, defaultHeight = 23.918.dp,
                viewportWidth = 23.9062f, viewportHeight = 23.918f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.1484f, 20.4023f)
                lineTo(20.3906f, 19.1602f)
                lineTo(4.7695f, 3.5391f)
                lineTo(3.5273f, 4.7813f)
                close()
...
private var _nosign: ImageVector? = null
