...
public val CupertinoIcons.Outlined.Suitcase: ImageVector
    get() {
        if (_suitcase != null) {
            return _suitcase!!
        }
        _suitcase = Builder(name = "Suitcase", defaultWidth = 27.1289.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(4.957f, 5.1094f)
                lineTo(4.957f, 21.7266f)
                lineTo(6.8438f, 21.7266f)
                lineTo(6.8438f, 5.1094f)
                close()
                moveTo(20.2734f, 5.1094f)
                lineTo(20.2734f, 21.7266f)
                lineTo(22.1602f, 21.7266f)
                lineTo(22.1602f, 5.1094f)
                close()
