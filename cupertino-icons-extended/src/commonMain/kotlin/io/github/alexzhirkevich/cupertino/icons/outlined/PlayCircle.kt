...
public val CupertinoIcons.Outlined.PlayCircle: ImageVector
    get() {
        if (_playCircle != null) {
            return _playCircle!!
        }
        _playCircle = Builder(name = "PlayCircle", defaultWidth = 23.9062.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.7617f, 16.5352f)
                lineTo(16.4297f, 12.5859f)
                curveTo(16.9219f, 12.3047f, 16.9102f, 11.625f, 16.4297f, 11.332f)
                lineTo(9.7617f, 7.3828f)
                curveTo(9.2578f, 7.0898f, 8.5898f, 7.3125f, 8.5898f, 7.8867f)
                lineTo(8.5898f, 16.0312f)
                curveTo(8.5898f, 16.5938f, 9.2109f, 16.8633f, 9.7617f, 16.5352f)
                close()
            }
        }
        .build()
