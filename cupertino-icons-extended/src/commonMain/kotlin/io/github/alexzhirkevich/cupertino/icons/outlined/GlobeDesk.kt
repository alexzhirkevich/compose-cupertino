...
public val CupertinoIcons.Outlined.GlobeDesk: ImageVector
    get() {
        if (_globeDesk != null) {
            return _globeDesk!!
        }
        _globeDesk = Builder(name = "GlobeDesk", defaultWidth = 22.8047.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.2109f, 17.1797f)
                curveTo(8.1914f, 17.1797f, 5.3672f, 14.3555f, 5.3672f, 10.3359f)
                curveTo(5.3672f, 6.3164f, 8.1914f, 3.5039f, 12.2109f, 3.5039f)
                curveTo(16.2305f, 3.5039f, 19.043f, 6.3164f, 19.043f, 10.3359f)
                curveTo(19.043f, 14.3555f, 16.2305f, 17.1797f, 12.2109f, 17.1797f)
                close()
            }
        }
        .build()
