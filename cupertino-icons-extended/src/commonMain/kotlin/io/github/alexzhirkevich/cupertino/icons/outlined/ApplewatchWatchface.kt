...
public val CupertinoIcons.Outlined.ApplewatchWatchface: ImageVector
    get() {
        if (_applewatchWatchface != null) {
            return _applewatchWatchface!!
        }
        _applewatchWatchface = Builder(name = "ApplewatchWatchface", defaultWidth = 16.9922.dp,
                defaultHeight = 25.0898.dp, viewportWidth = 16.9922f, viewportHeight =
                25.0898f).apply {
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(4.4648f, 10.0547f)
                curveTo(4.1836f, 10.3828f, 4.2305f, 10.8867f, 4.5703f, 11.1797f)
                lineTo(6.9727f, 13.1953f)
                curveTo(7.4766f, 13.6172f, 7.957f, 13.6172f, 8.4375f, 13.1953f)
                lineTo(12.5273f, 9.6211f)
                curveTo(12.8555f, 9.3281f, 12.8555f, 8.8242f, 12.5391f, 8.4961f)
                curveTo(12.2344f, 8.2031f, 11.7539f, 8.2031f, 11.4258f, 8.4961f)
                lineTo(7.6875f, 11.7422f)
                lineTo(5.5664f, 9.9492f)
                curveTo(5.2383f, 9.6914f, 4.7578f, 9.7266f, 4.4648f, 10.0547f)
                close()
            }
        }
        .build()
...
private var _applewatchWatchface: ImageVector? = null
