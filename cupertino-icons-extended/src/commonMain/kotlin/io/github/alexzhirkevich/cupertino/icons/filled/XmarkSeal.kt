...
public val CupertinoIcons.Filled.XmarkSeal: ImageVector
    get() {
        if (_xmarkSeal != null) {
            return _xmarkSeal!!
        }
        _xmarkSeal = Builder(name = "XmarkSeal", defaultWidth = 26.6221.dp, defaultHeight =
                26.6338.dp, viewportWidth = 26.6221f, viewportHeight = 26.6338f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.3735f, 18.2329f)
                curveTo(8.8345f, 18.2329f, 8.4126f, 17.7993f, 8.4126f, 17.2485f)
                curveTo(8.4126f, 16.9907f, 8.5063f, 16.7564f, 8.6938f, 16.5689f)
                lineTo(11.9399f, 13.3228f)
                lineTo(8.6938f, 10.0649f)
                curveTo(8.5063f, 9.8892f, 8.4126f, 9.6431f, 8.4126f, 9.3853f)
                curveTo(8.4126f, 8.8462f, 8.8345f, 8.436f, 9.3735f, 8.436f)
                curveTo(9.6431f, 8.436f, 9.854f, 8.5298f, 10.0415f, 8.7056f)
                lineTo(13.311f, 11.9634f)
                lineTo(16.604f, 8.6938f)
                curveTo(16.8032f, 8.4946f, 17.0142f, 8.4126f, 17.272f, 8.4126f)
                curveTo(17.811f, 8.4126f, 18.2446f, 8.8345f, 18.2446f, 9.3618f)
                curveTo(18.2446f, 9.6313f, 18.1626f, 9.854f, 17.9634f, 10.0532f)
                lineTo(14.6939f, 13.3228f)
                lineTo(17.9517f, 16.5571f)
                curveTo(18.1392f, 16.7446f, 18.2329f, 16.979f, 18.2329f, 17.2485f)
                curveTo(18.2329f, 17.7993f, 17.7993f, 18.2329f, 17.2485f, 18.2329f)
                curveTo(16.979f, 18.2329f, 16.7329f, 18.1392f, 16.5571f, 17.9517f)
                lineTo(13.311f, 14.6939f)
                lineTo(10.0767f, 17.9517f)
                curveTo(9.8892f, 18.1392f, 9.6431f, 18.2329f, 9.3735f, 18.2329f)
                close()
