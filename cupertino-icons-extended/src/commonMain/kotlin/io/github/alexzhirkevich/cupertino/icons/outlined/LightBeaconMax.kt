...
public val CupertinoIcons.Outlined.LightBeaconMax: ImageVector
    get() {
        ...
        _lightBeaconMax = Builder(name = "LightBeaconMax", defaultWidth = 27.7383.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(19.5469f, 22.7578f)
                lineTo(21.4336f, 22.7578f)
                ...
                lineTo(6.3047f, 22.7578f)
                lineTo(8.1914f, 22.7578f)
                lineTo(8.1914f, 14.0391f)
                curveTo(8.1914f, 10.8047f, 10.6406f, 8.3438f, 13.8633f, 8.3438f)
                curveTo(17.0977f, 8.3438f, 19.5469f, 10.8047f, 19.5469f, 14.0391f)
                close()
                ...
                close()
                moveTo(14.8125f, 14.2969f)
                curveTo(14.8125f, 13.7812f, 14.3789f, 13.3477f, 13.8633f, 13.3477f)
                curveTo(13.3477f, 13.3477f, 12.9375f, 13.7812f, 12.9375f, 14.2969f)
                lineTo(12.9375f, 22.7578f)
                lineTo(14.8125f, 22.7578f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
