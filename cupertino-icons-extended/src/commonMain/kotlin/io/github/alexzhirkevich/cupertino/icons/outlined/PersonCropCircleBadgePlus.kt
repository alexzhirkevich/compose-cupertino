...
public val CupertinoIcons.Outlined.PersonCropCircleBadgePlus: ImageVector
    get() {
        if (_personCropCircleBadgePlus != null) {
            return _personCropCircleBadgePlus!!
        }
        _personCropCircleBadgePlus = Builder(name = "PersonCropCircleBadgePlus", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.9531f, 21.9258f)
                curveTo(5.5195f, 21.9258f, 5.2383f, 21.6445f, 5.2383f, 21.2109f)
                lineTo(5.2383f, 18.9141f)
                lineTo(2.9414f, 18.9141f)
                curveTo(2.5195f, 18.9141f, 2.2266f, 18.6328f, 2.2266f, 18.1992f)
                curveTo(2.2266f, 17.7656f, 2.5195f, 17.4844f, 2.9414f, 17.4844f)
                lineTo(5.2383f, 17.4844f)
                lineTo(5.2383f, 15.1875f)
                curveTo(5.2383f, 14.7656f, 5.5195f, 14.4727f, 5.9531f, 14.4727f)
                curveTo(6.3867f, 14.4727f, 6.668f, 14.7656f, 6.668f, 15.1875f)
                lineTo(6.668f, 17.4844f)
                lineTo(8.9648f, 17.4844f)
                curveTo(9.3867f, 17.4844f, 9.6797f, 17.7656f, 9.6797f, 18.1992f)
                curveTo(9.6797f, 18.6328f, 9.3867f, 18.9141f, 8.9648f, 18.9141f)
                lineTo(6.668f, 18.9141f)
                lineTo(6.668f, 21.2109f)
                curveTo(6.668f, 21.6445f, 6.3867f, 21.9258f, 5.9531f, 21.9258f)
                close()
            }
        }
        .build()
...
private var _personCropCircleBadgePlus: ImageVector? = null
