...
public val CupertinoIcons.Outlined.PhoneArrowDownLeft: ImageVector
    get() {
        if (_phoneArrowDownLeft != null) {
            return _phoneArrowDownLeft!!
        }
        _phoneArrowDownLeft = Builder(name = "PhoneArrowDownLeft", defaultWidth = 23.0391.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(22.1719f, 0.0f)
                curveTo(21.9258f, 0.0f, 21.7383f, 0.082f, 21.5625f, 0.2578f)
                lineTo(16.5117f, 5.3203f)
                lineTo(14.7188f, 7.2656f)
                lineTo(14.9062f, 3.832f)
                lineTo(14.9062f, 2.0859f)
                curveTo(14.9062f, 1.6289f, 14.5664f, 1.2773f, 14.1094f, 1.2539f)
                curveTo(13.6406f, 1.2305f, 13.2305f, 1.6055f, 13.2305f, 2.0859f)
                lineTo(13.2305f, 8.8711f)
                curveTo(13.2305f, 9.4922f, 13.5352f, 9.8086f, 14.1562f, 9.8086f)
                lineTo(20.9648f, 9.8086f)
                curveTo(21.4453f, 9.8086f, 21.832f, 9.4102f, 21.8086f, 8.9297f)
                curveTo(21.7852f, 8.4727f, 21.4219f, 8.1328f, 20.9648f, 8.1328f)
                lineTo(19.1953f, 8.1328f)
                lineTo(15.75f, 8.3203f)
                lineTo(17.7188f, 6.5273f)
                lineTo(22.7578f, 1.4648f)
                curveTo(22.957f, 1.2773f, 23.0391f, 1.0664f, 23.0391f, 0.8203f)
                curveTo(23.0391f, 0.3633f, 22.6641f, 0.0f, 22.1719f, 0.0f)
                close()
            }
        }
        .build()
