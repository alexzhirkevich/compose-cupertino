...
public val CupertinoIcons.Outlined.PersonIcloud: ImageVector
    get() {
        ...
        _personIcloud = Builder(name = "PersonIcloud", defaultWidth = 29.4609.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.8125f, 18.8789f)
                lineTo(22.2891f, 18.8789f)
                curveTo(21.6211f, 16.9219f, 19.3594f, 14.4727f, 15.5508f, 14.4727f)
                curveTo(11.7422f, 14.4727f, 9.4805f, 16.9219f, 8.8125f, 18.8789f)
                close()
                moveTo(15.5508f, 13.0195f)
                curveTo(17.3086f, 13.0312f, 18.7383f, 11.4141f, 18.7383f, 9.5273f)
                curveTo(18.7383f, 7.6641f, 17.3086f, 6.1289f, 15.5508f, 6.1289f)
                curveTo(13.7812f, 6.1289f, 12.3633f, 7.6641f, 12.3633f, 9.5273f)
                curveTo(12.375f, 11.4141f, 13.7812f, 13.0078f, 15.5508f, 13.0195f)
                close()
