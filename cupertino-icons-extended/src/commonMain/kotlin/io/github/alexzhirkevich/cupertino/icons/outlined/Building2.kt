...
public val CupertinoIcons.Outlined.Building2: ImageVector
    get() {
        if (_building2 != null) {
            return _building2!!
        }
        _building2 = Builder(name = "Building2", defaultWidth = 27.5625.dp, defaultHeight =
                24.9961.dp, viewportWidth = 27.5625f, viewportHeight = 24.9961f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(16.7227f, 24.9961f)
                lineTo(25.6289f, 24.9961f)
                curveTo(26.8125f, 24.9961f, 27.5625f, 24.1641f, 27.5625f, 22.8633f)
                lineTo(27.5625f, 7.9102f)
                curveTo(27.5625f, 6.6094f, 26.8125f, 5.7773f, 25.6289f, 5.7773f)
                lineTo(17.5664f, 5.7773f)
                lineTo(17.5664f, 7.6641f)
                lineTo(25.0078f, 7.6641f)
                curveTo(25.4648f, 7.6641f, 25.6758f, 7.8867f, 25.6758f, 8.3438f)
                lineTo(25.6758f, 22.4297f)
                curveTo(25.6758f, 22.8867f, 25.4648f, 23.1094f, 25.0078f, 23.1094f)
                lineTo(16.7227f, 23.1094f)
                close()
                moveTo(21.2227f, 12.2227f)
                lineTo(23.1094f, 12.2227f)
                curveTo(23.3438f, 12.2227f, 23.5078f, 12.0586f, 23.5078f, 11.8242f)
                lineTo(23.5078f, 9.9961f)
                curveTo(23.5078f, 9.7617f, 23.3438f, 9.5977f, 23.1094f, 9.5977f)
                lineTo(21.2227f, 9.5977f)
                curveTo(20.9766f, 9.5977f, 20.8359f, 9.7617f, 20.8359f, 9.9961f)
                lineTo(20.8359f, 11.8242f)
                curveTo(20.8359f, 12.0586f, 20.9766f, 12.2227f, 21.2227f, 12.2227f)
                close()
                moveTo(21.2227f, 16.6992f)
                lineTo(23.1094f, 16.6992f)
                curveTo(23.3438f, 16.6992f, 23.5078f, 16.5352f, 23.5078f, 16.3008f)
                lineTo(23.5078f, 14.4727f)
                curveTo(23.5078f, 14.2383f, 23.3438f, 14.0742f, 23.1094f, 14.0742f)
                lineTo(21.2227f, 14.0742f)
                curveTo(20.9766f, 14.0742f, 20.8359f, 14.2383f, 20.8359f, 14.4727f)
                lineTo(20.8359f, 16.3008f)
                curveTo(20.8359f, 16.5352f, 20.9766f, 16.6992f, 21.2227f, 16.6992f)
                close()
                moveTo(21.2227f, 21.1758f)
                lineTo(23.1094f, 21.1758f)
                curveTo(23.3438f, 21.1758f, 23.5078f, 21.0117f, 23.5078f, 20.7773f)
                lineTo(23.5078f, 18.9492f)
                curveTo(23.5078f, 18.7148f, 23.3438f, 18.5508f, 23.1094f, 18.5508f)
                lineTo(21.2227f, 18.5508f)
                curveTo(20.9766f, 18.5508f, 20.8359f, 18.7148f, 20.8359f, 18.9492f)
                lineTo(20.8359f, 20.7773f)
                curveTo(20.8359f, 21.0117f, 20.9766f, 21.1758f, 21.2227f, 21.1758f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
