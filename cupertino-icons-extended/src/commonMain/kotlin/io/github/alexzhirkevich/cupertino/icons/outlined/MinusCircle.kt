...
public val CupertinoIcons.Outlined.MinusCircle: ImageVector
    get() {
        ...
        _minusCircle = Builder(name = "MinusCircle", defaultWidth = 23.9062.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.3477f, 12.9492f)
                lineTo(16.5469f, 12.9492f)
                curveTo(17.2031f, 12.9492f, 17.6484f, 12.5977f, 17.6484f, 11.9766f)
                curveTo(17.6484f, 11.3438f, 17.2266f, 10.9805f, 16.5469f, 10.9805f)
                lineTo(7.3477f, 10.9805f)
                curveTo(6.668f, 10.9805f, 6.2344f, 11.3438f, 6.2344f, 11.9766f)
                curveTo(6.2344f, 12.5977f, 6.6914f, 12.9492f, 7.3477f, 12.9492f)
                close()
            }
        }
        .build()
