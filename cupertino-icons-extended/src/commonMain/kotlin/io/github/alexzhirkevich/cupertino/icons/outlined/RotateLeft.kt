...
public val CupertinoIcons.Outlined.RotateLeft: ImageVector
    get() {
        if (_rotateLeft != null) {
            return _rotateLeft!!
        }
        _rotateLeft = Builder(name = "RotateLeft", defaultWidth = 23.4844.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(3.0469f, 23.9657f)
                curveTo(2.25f, 23.9657f, 1.8867f, 23.6376f, 1.8867f, 22.8173f)
                lineTo(1.8867f, 11.286f)
                curveTo(1.8867f, 10.454f, 2.25f, 10.1258f, 3.0469f, 10.1258f)
                lineTo(14.5898f, 10.1258f)
                curveTo(15.3984f, 10.1258f, 15.75f, 10.454f, 15.75f, 11.286f)
                lineTo(15.75f, 22.8173f)
                curveTo(15.75f, 23.6376f, 15.3984f, 23.9657f, 14.5898f, 23.9657f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(12.8789f, 2.8016f, 12.8672f, 3.2118f, 13.3711f, 3.5751f)
