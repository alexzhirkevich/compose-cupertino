...
public val CupertinoIcons.Outlined.Clock: ImageVector
    get() {
        if (_clock != null) {
            return _clock!!
        }
        _clock = Builder(name = "Clock", defaultWidth = 23.9062.dp, defaultHeight = 23.918.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(11.9414f, 13.2188f)
                curveTo(12.3984f, 13.2188f, 12.7617f, 12.8672f, 12.7617f, 12.3984f)
                lineTo(12.7617f, 4.5f)
                curveTo(12.7617f, 4.043f, 12.3984f, 3.6914f, 11.9414f, 3.6914f)
                curveTo(11.4844f, 3.6914f, 11.1328f, 4.043f, 11.1328f, 4.5f)
                lineTo(11.1328f, 11.5898f)
                lineTo(5.8242f, 11.5898f)
                curveTo(5.3555f, 11.5898f, 5.0039f, 11.9414f, 5.0039f, 12.3984f)
                curveTo(5.0039f, 12.8672f, 5.3555f, 13.2188f, 5.8242f, 13.2188f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
