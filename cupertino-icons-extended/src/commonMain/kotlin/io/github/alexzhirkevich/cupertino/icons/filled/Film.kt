...
public val CupertinoIcons.Filled.Film: ImageVector
    get() {
        if (_film != null) {
            return _film!!
        }
        _film = Builder(name = "Film", defaultWidth = 27.6328.dp, defaultHeight = 21.6211.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.7305f, 10.8281f)
                curveTo(5.7305f, 10.3359f, 6.1172f, 9.9375f, 6.6094f, 9.9375f)
                lineTo(21.0234f, 9.9375f)
                curveTo(21.5156f, 9.9375f, 21.9141f, 10.3359f, 21.9141f, 10.8281f)
                curveTo(21.9141f, 11.3203f, 21.5156f, 11.707f, 21.0234f, 11.707f)
                lineTo(6.6094f, 11.707f)
                curveTo(6.1172f, 11.707f, 5.7305f, 11.3203f, 5.7305f, 10.8281f)
                close()
