...
public val CupertinoIcons.Outlined.CheckmarkShield: ImageVector
    get() {
        if (_checkmarkShield != null) {
            return _checkmarkShield!!
        }
        _checkmarkShield = Builder(name = "CheckmarkShield", defaultWidth = 19.4766.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.4609f, 17.4492f)
                curveTo(8.8477f, 17.4492f, 9.1758f, 17.2617f, 9.4102f, 16.9102f)
                lineTo(14.7656f, 8.4727f)
                curveTo(14.9062f, 8.25f, 15.0469f, 7.9922f, 15.0469f, 7.7227f)
                curveTo(15.0469f, 7.207f, 14.5781f, 6.8672f, 14.0977f, 6.8672f)
                curveTo(13.793f, 6.8672f, 13.5f, 7.043f, 13.2773f, 7.3945f)
                lineTo(8.4141f, 15.1992f)
                lineTo(6.1055f, 12.2109f)
                curveTo(5.8242f, 11.8359f, 5.5664f, 11.7305f, 5.25f, 11.7305f)
                curveTo(4.7344f, 11.7305f, 4.3359f, 12.1406f, 4.3359f, 12.668f)
                curveTo(4.3359f, 12.9141f, 4.4414f, 13.1719f, 4.6055f, 13.3945f)
                lineTo(7.4648f, 16.9102f)
                curveTo(7.7578f, 17.2969f, 8.0742f, 17.4492f, 8.4609f, 17.4492f)
                close()
            }
        }
        .build()
