...
public val CupertinoIcons.Outlined.LockSlash: ImageVector
    get() {
        if (_lockSlash != null) {
            return _lockSlash!!
        }
        _lockSlash = Builder(name = "LockSlash", defaultWidth = 21.9068.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.3457f, 11.3848f)
                lineTo(16.0254f, 11.3848f)
                curveTo(16.541f, 11.3848f, 16.8223f, 11.6895f, 16.8223f, 12.2637f)
                lineTo(16.8223f, 15.8613f)
                ...
                lineTo(15.8613f, 21.3223f)
                curveTo(15.7676f, 21.416f, 15.627f, 21.4863f, 15.4629f, 21.4863f)
                lineTo(5.4199f, 21.4863f)
                curveTo(4.916f, 21.4863f, 4.6231f, 21.1699f, 4.6231f, 20.5957f)
                lineTo(4.6231f, 12.2637f)
                curveTo(4.6231f, 11.6895f, 4.916f, 11.3848f, 5.4199f, 11.3848f)
                lineTo(5.9121f, 11.3848f)
