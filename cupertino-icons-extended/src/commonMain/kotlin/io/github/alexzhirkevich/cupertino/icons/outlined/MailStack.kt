...
public val CupertinoIcons.Outlined.MailStack: ImageVector
    get() {
        if (_mailStack != null) {
            return _mailStack!!
        }
        _mailStack = Builder(name = "MailStack", defaultWidth = 24.5508.dp, defaultHeight =
                25.9805.dp, viewportWidth = 24.5508f, viewportHeight = 25.9805f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(4.9102f, 12.9727f)
                lineTo(12.3516f, 12.9727f)
                curveTo(12.7969f, 12.9727f, 13.1484f, 12.6094f, 13.1484f, 12.1641f)
                curveTo(13.1484f, 11.7188f, 12.7969f, 11.3555f, 12.3516f, 11.3555f)
                lineTo(4.9102f, 11.3555f)
                curveTo(4.4414f, 11.3555f, 4.1016f, 11.7188f, 4.1016f, 12.1641f)
                curveTo(4.1016f, 12.6094f, 4.4414f, 12.9727f, 4.9102f, 12.9727f)
                close()
                moveTo(4.9102f, 16.043f)
                lineTo(10.2188f, 16.043f)
                curveTo(10.6641f, 16.043f, 11.0273f, 15.6914f, 11.0273f, 15.2461f)
                curveTo(11.0273f, 14.7891f, 10.6641f, 14.4375f, 10.2188f, 14.4375f)
                lineTo(4.9102f, 14.4375f)
                curveTo(4.4414f, 14.4375f, 4.1016f, 14.7891f, 4.1016f, 15.2461f)
                curveTo(4.1016f, 15.6914f, 4.4414f, 16.043f, 4.9102f, 16.043f)
                close()
                moveTo(17.6836f, 16.3594f)
                curveTo(19.1953f, 16.3594f, 20.4258f, 15.1289f, 20.4258f, 13.5938f)
                curveTo(20.4258f, 12.0586f, 19.1953f, 10.8281f, 17.6836f, 10.8281f)
                curveTo(16.1484f, 10.8281f, 14.9062f, 12.0586f, 14.9062f, 13.5938f)
                curveTo(14.9062f, 15.1289f, 16.1484f, 16.3594f, 17.6836f, 16.3594f)
                close()
