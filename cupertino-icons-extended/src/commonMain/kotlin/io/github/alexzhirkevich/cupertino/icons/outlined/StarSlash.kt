...
public val CupertinoIcons.Outlined.StarSlash: ImageVector
    get() {
        if (_starSlash != null) {
            return _starSlash!!
        }
        _starSlash = Builder(name = "StarSlash", defaultWidth = 26.0251.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(19.9464f, 24.9023f, 20.5324f, 25.0195f, 21.0363f, 24.6562f)
                curveTo(21.1769f, 24.5508f, 21.2824f, 24.4102f, 21.4582f, 24.1523f)
                ...
                lineTo(7.6886f, 10.3477f)
                lineTo(5.9308f, 8.6016f)
                ...
                lineTo(10.1261f, 6.2695f)
                lineTo(11.5207f, 7.6641f)
