...
public val CupertinoIcons.Outlined.Facemask: ImageVector
    get() {
        if (_facemask != null) {
            return _facemask!!
        }
        _facemask = Builder(name = "Facemask", defaultWidth = 35.8242.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.7656f, 6.5391f)
                curveTo(11.7656f, 7.0547f, 12.1875f, 7.4883f, 12.7031f, 7.4883f)
                lineTo(23.1445f, 7.4883f)
                curveTo(23.6602f, 7.4883f, 24.082f, 7.0547f, 24.082f, 6.5391f)
                curveTo(24.082f, 6.0352f, 23.6602f, 5.6016f, 23.1445f, 5.6016f)
                lineTo(12.7031f, 5.6016f)
                curveTo(12.1875f, 5.6016f, 11.7656f, 6.0352f, 11.7656f, 6.5391f)
                close()
                moveTo(11.7656f, 10.9219f)
                curveTo(11.7656f, 11.4375f, 12.1875f, 11.8594f, 12.7031f, 11.8594f)
                lineTo(23.1445f, 11.8594f)
                curveTo(23.6602f, 11.8594f, 24.082f, 11.4375f, 24.082f, 10.9219f)
                curveTo(24.082f, 10.4062f, 23.6602f, 9.9727f, 23.1445f, 9.9727f)
                lineTo(12.7031f, 9.9727f)
                curveTo(12.1875f, 9.9727f, 11.7656f, 10.4062f, 11.7656f, 10.9219f)
                close()
                moveTo(0.0f, 7.6992f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.918f, 16.0898f)
                curveTo(12.1172f, 16.0898f, 7.9102f, 14.0391f, 7.9102f, 11.2969f)
                lineTo(7.9102f, 5.4375f)
                curveTo(7.9102f, 3.1523f, 11.4609f, 1.8867f, 17.918f, 1.8867f)
                curveTo(24.3633f, 1.8867f, 27.9258f, 3.1523f, 27.9258f, 5.4375f)
                lineTo(27.9258f, 11.2969f)
                curveTo(27.9258f, 14.0391f, 23.707f, 16.0898f, 17.918f, 16.0898f)
                close()
            }
        }
        .build()
