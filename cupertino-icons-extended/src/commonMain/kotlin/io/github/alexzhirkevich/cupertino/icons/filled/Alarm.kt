...
public val CupertinoIcons.Filled.Alarm: ImageVector
    get() {
        if (_alarm != null) {
            return _alarm!!
        }
        _alarm = Builder(name = "Alarm", defaultWidth = 22.4062.dp, defaultHeight = 26.3086.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.4141f, 14.3906f, 5.0625f, 14.0391f, 5.0625f, 13.582f)
                curveTo(5.0625f, 13.125f, 5.4141f, 12.7617f, 5.8711f, 12.7617f)
                lineTo(10.3828f, 12.7617f)
                lineTo(10.3828f, 6.4805f)
                curveTo(10.3828f, 6.0234f, 10.7344f, 5.6602f, 11.1914f, 5.6602f)
                curveTo(11.6484f, 5.6602f, 12.0117f, 6.0234f, 12.0117f, 6.4805f)
                lineTo(12.0117f, 13.582f)
                curveTo(12.0117f, 14.0391f, 11.6484f, 14.3906f, 11.1914f, 14.3906f)
                close()
