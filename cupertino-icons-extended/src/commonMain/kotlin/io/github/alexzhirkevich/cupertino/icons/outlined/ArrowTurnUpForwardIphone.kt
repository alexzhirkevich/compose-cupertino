...
public val CupertinoIcons.Outlined.ArrowTurnUpForwardIphone: ImageVector
    get() {
        ...
        _arrowTurnUpForwardIphone = Builder(name = "ArrowTurnUpForwardIphone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.1562f, 22.9219f)
                curveTo(19.1719f, 22.9219f, 18.6094f, 22.3945f, 18.6094f, 21.457f)
                lineTo(18.6094f, 3.3516f)
                curveTo(18.6094f, 2.4141f, 19.1719f, 1.8867f, 20.1562f, 1.8867f)
                lineTo(28.3594f, 1.8867f)
                curveTo(29.3438f, 1.8867f, 29.9062f, 2.4141f, 29.9062f, 3.3516f)
                lineTo(29.9062f, 21.457f)
                curveTo(29.9062f, 22.3945f, 29.3438f, 22.9219f, 28.3594f, 22.9219f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
