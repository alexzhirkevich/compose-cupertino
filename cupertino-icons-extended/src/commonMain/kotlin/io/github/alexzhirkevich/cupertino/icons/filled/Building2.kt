...
public val CupertinoIcons.Filled.Building2: ImageVector
    get() {
        if (_building2 != null) {
            return _building2!!
        }
        _building2 = Builder(name = "Building2", defaultWidth = 27.5859.dp, defaultHeight =
                24.9961.dp, viewportWidth = 27.5859f, viewportHeight = 24.9961f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.8906f, 24.9961f)
                lineTo(25.6523f, 24.9961f)
                curveTo(26.8359f, 24.9961f, 27.5859f, 24.1641f, 27.5859f, 22.8633f)
                lineTo(27.5859f, 7.9102f)
                curveTo(27.5859f, 6.6094f, 26.8359f, 5.7773f, 25.6523f, 5.7773f)
                lineTo(19.4648f, 5.7773f)
                lineTo(19.4648f, 22.8633f)
                curveTo(19.4648f, 23.6484f, 19.2773f, 24.3633f, 18.8906f, 24.9961f)
                close()
                moveTo(22.125f, 11.707f)
                lineTo(22.125f, 9.832f)
                curveTo(22.125f, 9.5859f, 22.2773f, 9.4219f, 22.5352f, 9.4219f)
                lineTo(24.4805f, 9.4219f)
                curveTo(24.7266f, 9.4219f, 24.8906f, 9.5859f, 24.8906f, 9.832f)
                lineTo(24.8906f, 11.707f)
                curveTo(24.8906f, 11.9531f, 24.7266f, 12.1289f, 24.4805f, 12.1289f)
                lineTo(22.5352f, 12.1289f)
                curveTo(22.2773f, 12.1289f, 22.125f, 11.9531f, 22.125f, 11.707f)
                close()
                moveTo(22.125f, 16.3242f)
                lineTo(22.125f, 14.4492f)
                curveTo(22.125f, 14.2031f, 22.2773f, 14.0391f, 22.5352f, 14.0391f)
                lineTo(24.4805f, 14.0391f)
                curveTo(24.7266f, 14.0391f, 24.8906f, 14.2031f, 24.8906f, 14.4492f)
                lineTo(24.8906f, 16.3242f)
                curveTo(24.8906f, 16.5703f, 24.7266f, 16.7344f, 24.4805f, 16.7344f)
                lineTo(22.5352f, 16.7344f)
                curveTo(22.2773f, 16.7344f, 22.125f, 16.5703f, 22.125f, 16.3242f)
                close()
                moveTo(22.125f, 20.9414f)
                lineTo(22.125f, 19.0664f)
                curveTo(22.125f, 18.8203f, 22.2773f, 18.6445f, 22.5352f, 18.6445f)
                lineTo(24.4805f, 18.6445f)
                curveTo(24.7266f, 18.6445f, 24.8906f, 18.8203f, 24.8906f, 19.0664f)
                lineTo(24.8906f, 20.9414f)
                curveTo(24.8906f, 21.1875f, 24.7266f, 21.3516f, 24.4805f, 21.3516f)
                lineTo(22.5352f, 21.3516f)
                curveTo(22.2773f, 21.3516f, 22.125f, 21.1875f, 22.125f, 20.9414f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
