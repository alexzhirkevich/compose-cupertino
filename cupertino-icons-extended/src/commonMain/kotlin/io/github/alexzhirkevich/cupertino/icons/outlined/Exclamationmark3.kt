...
public val CupertinoIcons.Outlined.Exclamationmark3: ImageVector
    get() {
        if (_exclamationmark3 != null) {
            return _exclamationmark3!!
        }
        _exclamationmark3 = Builder(name = "Exclamationmark3", defaultWidth = 20.6367.dp,
                defaultHeight = 22.4414.dp, viewportWidth = 20.6367f, viewportHeight =
                22.4414f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.9844f, 15.9844f)
                curveTo(19.5938f, 15.9844f, 20.0273f, 15.5742f, 20.0391f, 14.9414f)
                lineTo(20.1445f, 1.2891f)
                curveTo(20.1445f, 1.2891f, 20.1445f, 1.2891f, 20.1445f, 1.2891f)
                curveTo(20.1445f, 0.6211f, 19.5938f, 0.1641f, 18.9727f, 0.1641f)
                curveTo(18.3398f, 0.1641f, 17.7891f, 0.6211f, 17.7891f, 1.2891f)
                curveTo(17.7891f, 1.2891f, 17.7891f, 1.2891f, 17.7891f, 1.2891f)
                lineTo(17.918f, 14.9414f)
                curveTo(17.9297f, 15.5742f, 18.3633f, 15.9844f, 18.9844f, 15.9844f)
                close()
                moveTo(18.9727f, 22.4414f)
                curveTo(19.8984f, 22.4414f, 20.6367f, 21.6914f, 20.6367f, 20.7773f)
                curveTo(20.6367f, 19.8516f, 19.8984f, 19.1133f, 18.9727f, 19.1133f)
                curveTo(18.0469f, 19.1133f, 17.2969f, 19.8516f, 17.2969f, 20.7773f)
                curveTo(17.2969f, 21.6914f, 18.0469f, 22.4414f, 18.9727f, 22.4414f)
                close()
            }
        }
        .build()
...
private var _exclamationmark3: ImageVector? = null
