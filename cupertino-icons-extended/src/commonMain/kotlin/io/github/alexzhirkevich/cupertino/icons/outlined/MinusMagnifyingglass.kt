...
public val CupertinoIcons.Outlined.MinusMagnifyingglass: ImageVector
    get() {
        if (_minusMagnifyingglass != null) {
            return _minusMagnifyingglass!!
        }
        _minusMagnifyingglass = Builder(name = "MinusMagnifyingglass", defaultWidth = 22.8984.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.3398f, 10.207f)
                lineTo(12.3633f, 10.207f)
                curveTo(12.832f, 10.207f, 13.2188f, 9.8203f, 13.2188f, 9.3516f)
                curveTo(13.2188f, 8.8828f, 12.832f, 8.4844f, 12.3633f, 8.4844f)
                lineTo(6.3398f, 8.4844f)
                curveTo(5.8711f, 8.4844f, 5.4727f, 8.8828f, 5.4727f, 9.3516f)
                curveTo(5.4727f, 9.8203f, 5.8711f, 10.207f, 6.3398f, 10.207f)
                close()
            }
        }
        .build()
...
private var _minusMagnifyingglass: ImageVector? = null
