...
public val CupertinoIcons.Outlined.EllipsisBubble: ImageVector
    get() {
        ...
        _ellipsisBubble = Builder(name = "EllipsisBubble", defaultWidth = 25.8281.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.1836f, 13.0312f)
                curveTo(8.1094f, 13.0312f, 8.8594f, 12.2812f, 8.8594f, 11.3555f)
                curveTo(8.8594f, 10.4297f, 8.1094f, 9.6797f, 7.1836f, 9.6797f)
                curveTo(6.2578f, 9.6797f, 5.5078f, 10.4297f, 5.5078f, 11.3555f)
                curveTo(5.5078f, 12.2812f, 6.2578f, 13.0312f, 7.1836f, 13.0312f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.9258f, 13.0312f)
                curveTo(13.8398f, 13.0312f, 14.6016f, 12.2812f, 14.6016f, 11.3555f)
                curveTo(14.6016f, 10.4297f, 13.8398f, 9.6797f, 12.9258f, 9.6797f)
                curveTo(12.0f, 9.6797f, 11.2383f, 10.4297f, 11.2383f, 11.3555f)
                curveTo(11.2383f, 12.2812f, 12.0f, 13.0312f, 12.9258f, 13.0312f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.6562f, 13.0312f)
                curveTo(19.582f, 13.0312f, 20.332f, 12.2812f, 20.332f, 11.3555f)
                curveTo(20.332f, 10.4297f, 19.582f, 9.6797f, 18.6562f, 9.6797f)
                curveTo(17.7305f, 9.6797f, 16.9805f, 10.4297f, 16.9805f, 11.3555f)
                curveTo(16.9805f, 12.2812f, 17.7305f, 13.0312f, 18.6562f, 13.0312f)
                close()
            }
        }
        .build()
