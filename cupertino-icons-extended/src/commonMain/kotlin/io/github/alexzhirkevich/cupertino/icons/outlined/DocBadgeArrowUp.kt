...
public val CupertinoIcons.Outlined.DocBadgeArrowUp: ImageVector
    get() {
        if (_docBadgeArrowUp != null) {
            return _docBadgeArrowUp!!
        }
        _docBadgeArrowUp = Builder(name = "DocBadgeArrowUp", defaultWidth = 24.7148.dp,
                defaultHeight = 29.543.dp, viewportWidth = 24.7148f, viewportHeight =
                29.543f).apply {
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.9648f, 19.8047f)
                curveTo(6.1641f, 19.8047f, 6.3164f, 19.8984f, 6.5156f, 20.0742f)
                lineTo(9.5508f, 22.8984f)
                curveTo(9.7383f, 23.0508f, 9.8086f, 23.2266f, 9.8086f, 23.4492f)
                curveTo(9.8086f, 23.8477f, 9.5039f, 24.1641f, 9.0938f, 24.1406f)
                curveTo(8.8945f, 24.1289f, 8.707f, 24.0469f, 8.5664f, 23.9062f)
                lineTo(7.4414f, 22.7812f)
                lineTo(6.6797f, 21.9844f)
                lineTo(6.7383f, 23.4844f)
                lineTo(6.7383f, 26.5898f)
                curveTo(6.7383f, 27.0f, 6.3867f, 27.3398f, 5.9648f, 27.3398f)
                curveTo(5.543f, 27.3398f, 5.1914f, 27.0f, 5.1914f, 26.5898f)
                lineTo(5.1914f, 23.4844f)
                lineTo(5.25f, 21.9844f)
                lineTo(4.4766f, 22.7812f)
                lineTo(3.375f, 23.9062f)
                curveTo(3.2227f, 24.0469f, 3.0234f, 24.1523f, 2.8242f, 24.1406f)
                curveTo(2.4258f, 24.1406f, 2.0859f, 23.8477f, 2.1094f, 23.4492f)
                curveTo(2.1211f, 23.2266f, 2.2031f, 23.0508f, 2.3789f, 22.8984f)
                lineTo(5.4023f, 20.0742f)
                curveTo(5.6133f, 19.8867f, 5.7773f, 19.8047f, 5.9648f, 19.8047f)
                close()
            }
        }
        .build()
