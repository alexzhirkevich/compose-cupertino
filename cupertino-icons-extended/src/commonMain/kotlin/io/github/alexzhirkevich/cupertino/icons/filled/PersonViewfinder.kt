...
public val CupertinoIcons.Filled.PersonViewfinder: ImageVector
    get() {
        if (_personViewfinder != null) {
            return _personViewfinder!!
        }
        _personViewfinder = Builder(name = "PersonViewfinder", defaultWidth = 22.9453.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(5.5781f, 18.0234f)
                lineTo(17.3672f, 18.0234f)
                curveTo(17.8711f, 18.0234f, 18.1289f, 17.6836f, 18.1289f, 17.2031f)
                curveTo(18.1289f, 15.7969f, 15.9961f, 12.1406f, 11.4727f, 12.1406f)
                curveTo(6.9492f, 12.1406f, 4.8164f, 15.7969f, 4.8164f, 17.2031f)
                curveTo(4.8164f, 17.6836f, 5.0742f, 18.0234f, 5.5781f, 18.0234f)
                close()
                moveTo(11.4727f, 11.0859f)
                curveTo(13.3125f, 11.0977f, 14.7773f, 9.5391f, 14.7773f, 7.4648f)
                curveTo(14.7773f, 5.5313f, 13.3125f, 3.9258f, 11.4727f, 3.9258f)
                curveTo(9.6328f, 3.9258f, 8.168f, 5.5313f, 8.168f, 7.4648f)
                curveTo(8.168f, 9.5391f, 9.6328f, 11.0742f, 11.4727f, 11.0859f)
                close()
            }
        }
        .build()
...
private var _personViewfinder: ImageVector? = null
