...
//        get() = Density(
//            density = layer.layer.contentScale,
//            fontScale = UIFont
//                .preferredFontForTextStyle(UIFontTextStyleBody)
//                .pointSize.toFloat() / 17
//        )
//
...
//    }
//
//    private val contentSizeListener = object : NSObject(){
//        @Suppress("unused")
//        @ObjCAction
...
//        )
//        NSNotificationCenter.defaultCenter.addObserver(
//            observer = contentSizeListener,
//            selector = NSSelectorFromString("contentSizeChanged:"),
...
//            DpOffset(x.dp, y.dp).let {
//                Offset(
//                    it.x.value * density.density,
//                    it.y.value * density.density
//                )
//            }
//        }
//
