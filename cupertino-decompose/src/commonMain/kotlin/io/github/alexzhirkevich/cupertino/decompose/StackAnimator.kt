 ...
 */
fun interface SheetStackAnimator {
 ...
 */
fun sheetStackAnimator(
    animationSpec: FiniteAnimationSpec<Float> = tween(),
    frame: @Composable (factor: Float, direction: TriDirection, content: @Composable (Modifier) -> Unit) -> Unit,
): SheetStackAnimator =
    DefaultSheetStackAnimator(
 ...
 */
operator fun SheetStackAnimator.plus(other: SheetStackAnimator): SheetStackAnimator =
...
private class PlusStackAnimator(
    private val first: SheetStackAnimator,
    private val second: SheetStackAnimator,
) : SheetStackAnimator {
