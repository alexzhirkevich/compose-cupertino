    ...
    BoxWithConstraints(
        modifier
            .anchoredDraggable(
                ...
                enabled = true/*state.currentValue != CupertinoSwipeBoxValue.DismissedToStart &&
        ...
        CompositionLocalProvider(LocalSwipeBoxState provides state) {
            SubcomposeLayout(
                ...
                val pleceables = itemsMeasurables.mapIndexed { index, it ->
                    ...
                    val min = (abs(state.offset) / itemsCount).coerceAtLeast(itemWidth.toPx() + 1)
    ...
    override fun MeasureScope.measure(
        ...
        if (isLookingAhead || !didLookahead) {
            ...
            val newAnchors = DraggableAnchors {
                CupertinoSwipeBoxValue.Collapsed at 0f
                if (enableStartToEnd) {
                    CupertinoSwipeBoxValue.ExpandedToEnd at itemsWidth
                    CupertinoSwipeBoxValue.DismissedToEnd at width
                }
                if (enableEndToStart) {
                    CupertinoSwipeBoxValue.ExpandedToStart at  -itemsWidth
                    CupertinoSwipeBoxValue.DismissedToStart at -width
                }
            }
