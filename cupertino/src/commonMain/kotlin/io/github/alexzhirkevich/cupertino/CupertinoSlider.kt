            ...
            sliderPositions.tickFractions.groupBy {
                ...
                list.fastForEach {
                    drawLine(
                        ...
                        start = Offset(lerp(sliderStart, sliderEnd, it).x, center.y - 1.dp.toPx()),
                        end = Offset(lerp(sliderStart, sliderEnd, it).x, center.y + 1.dp.toPx()),
...
internal object SliderTokens {
    ...
    val InactiveTrackHeight = 3.0.dp
