...
): String = PlatformDateFormat
    .formatWithSkeleton(utcTimeMillis, skeleton, locale)
 ...
 *
 * This data class hold the delimiter that is used by the current [CalendarLocale] when representing dates
